...
class StudentProvider with ChangeNotifier {
  ...
  Future<Student> fetchStudentById(BuildContext context, String studentId) async {
    final token = Provider.of<AuthProvider>(context, listen: false).token;
    return await StudentService.fetchStudentById(studentId, token);
  }

  Future<void> updateStudent(BuildContext context, String studentId, Map<String, dynamic> data) async {
    final token = Provider.of<AuthProvider>(context, listen: false).token;
