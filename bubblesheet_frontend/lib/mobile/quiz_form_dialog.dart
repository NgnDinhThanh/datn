...
class QuizFormDialog extends StatefulWidget {
  ...
  const QuizFormDialog({Key? key, this.quiz}) : super(key: key);
...
class _QuizFormDialogState extends State<QuizFormDialog> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      ...
      if (answerSheetProvider.answerSheets.isEmpty) {
        ...
        print('Answer sheets loaded: ${answerSheetProvider.answerSheets.length}');
      }
      final classProvider = Provider.of<ClassProvider>(context, listen: false);
      if (classProvider.classes.isEmpty) {
        print('Fetching classes...');
        await classProvider.fetchClasses(context);
        print('Classes loaded: ${classProvider.classes.length}');
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    print('Building with ${answerSheetProvider.answerSheets.length} answer sheets');
    print('Selected answer sheet ID: $_selectedAnswerSheetId');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.quiz == null ? 'New Quiz' : 'Edit Quiz: ${widget.quiz!.name}',
